...
| Utility | Size | Usage |
|---|---|---|
| `text-display` | 36px | reserved, currently unused |
| `text-section` | 28px | section headings, and the name in the hero |
...
Max-width `var(--container-content)` (768px / 48rem), centred, with 24px horizontal padding.
